...
selectedStory = EmergencyStory.create! name: 'Charles', location: 'The Embarcadero, San Francisco', image: File.open('app/assets/images/placeholder/story-1.jpg'), story: "It doesn't matter if it's good times or bad times, we all need to eat. It's a natural fit for chefs to stand up to help (in an emergency). Friends—both digitally and in person.", call_to_action_cd: 0, selected: true
